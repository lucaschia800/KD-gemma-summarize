...
input_ids = tokenizer(sample['article'], return_tensors='pt').input_ids.to('cuda')

output = teacher.generate(input_ids=input_ids, max_new_tokens=250, do_sample=False, early_stopping=True)
